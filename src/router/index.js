...
import RechargeRecordDetails from '../pages/user-center/RechargeRecordDetails.vue'
...
export default new Router({
  routes: [
    ...
    {path: '/homePage/myData/userInfo/RechargeRecordDetails', name: 'RechargeRecordDetails', component: RechargeRecordDetails, meta: {title:'充值纪录'}},
